...
export const ShopSchema = BaseSchema.extend({
  ...
  pickupProvinceId: z.number().int().positive().nullable().optional(),
  pickupDistrictId: z.number().int().positive().nullable().optional(),
  pickupWardId: z.number().int().positive().nullable().optional(),
