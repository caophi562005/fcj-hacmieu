          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-surface-alt border-b border-slate-100 text-ink-muted">
                <th className="py-3 px-4 text-left font-semibold w-[140px]">ID</th>
              ...
              {data.reports.map((report) => (
                ...
                >
                  ...
                  <td className="py-3 px-4 text-center align-middle">
                    <span
                      className={`inline-flex px-2.5 py-0.5 rounded-full border text-[11px] font-bold uppercase tracking-wider ${statusBadgeClass(report.status)}`}
                    >
