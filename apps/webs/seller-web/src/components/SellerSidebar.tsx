    ...
    >
      <div className="p-6">
        <Link href="/" className="block select-none">
          <h1 className="text-2xl font-black text-primary tracking-tight">V-Shop</h1>
          <p className="text-slate-400 text-xs mt-1">Seller Center</p>
        </Link>
      </div>
      ...
      <div className="p-6 border-t border-sidebar-border">
        <div className="flex items-center gap-3">
          ...
          <span className="text-slate-300 text-sm">Shop đang hoạt động</span>
        </div>
      </div>
    </nav>
  );
