...
export default defineConfig({
  resolve: {
    alias: [
      ...
      {
        find: '@prisma-client/catalog-service',
        replacement: `${workspaceRoot}/apps/services/catalog-service/src/generated/prisma-client/client.ts`,
      },
    ],
  },
  test: {
    root: path.join(workspaceRoot, 'apps/services/catalog-service'),
    environment: 'node',
    include: ['src/**/*.spec.ts'],
    globals: true,
  },
