-- Prisma tables use utf8mb4_unicode_ci. Routine string parameters inherit the
-- database default, so standardize it before recreating routines.
ALTER DATABASE CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

DROP FUNCTION `fn_calculate_discount`;
DROP FUNCTION `fn_order_grand_total`;
DROP PROCEDURE `sp_change_order_status`;

CREATE FUNCTION `fn_calculate_discount`(
    p_type VARCHAR(20), p_value INT, p_subtotal INT, p_max_discount INT
)
RETURNS INT
DETERMINISTIC
BEGIN
